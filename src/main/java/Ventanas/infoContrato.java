 ...
 * @author Jose
 */
public class infoContrato extends javax.swing.JFrame {

    /**
     * Creates new form infoContrato
     */
    private RevDocenteBO revBO = new RevDocenteBO();
    ...
    public void listarContrato(){
        revBO.listarRevDocenteDo(tblContrato,Integer.parseInt(login.codigo));
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        try {
            ...
            Logger.getLogger(infoContrato.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(infoContrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new infoContrato().setVisible(true);
            }
        });
    }
