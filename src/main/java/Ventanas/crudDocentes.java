...
public class crudDocentes extends javax.swing.JFrame {
    ...
    private DocentesBO doBo = new DocentesBO();
    ...
    public void listarDocentes(){
        doBo.listarDocente(tblLista);
    }
    
    public void IdMax(){
        txtCodigo.setText(doBo.getMaxID() + "");
    }
    ...
    private void initComponents() {
        ...
        txtdoContraseña = new javax.swing.JTextField();
        ...
        temCerrarSesion = new javax.swing.JMenuItem();
        ...
        lbCorreo1.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        lbCorreo1.setForeground(new java.awt.Color(255, 255, 255));
        lbCorreo1.setText("Contraseña:");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtdoContraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbCorreo1)
                    .addComponent(txtdoContraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        menuArchivo.add(txtMenu);

        temCerrarSesion.setText("Cerrar sesion");
        temCerrarSesion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                temCerrarSesionActionPerformed(evt);
            }
        });
        menuArchivo.add(temCerrarSesion);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 127, Short.MAX_VALUE)
                    .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    private void tblListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListaMouseClicked
        ...
        txtDireccion.setText(tblLista.getValueAt(seleccion, 2) + "");
        txtTelefono.setText(tblLista.getValueAt(seleccion, 3) + "");
        txtCorreo.setText(tblLista.getValueAt(seleccion, 4) + "");
        txtCurso.setText(tblLista.getValueAt(seleccion, 5) + "");
        txtSalario.setText(tblLista.getValueAt(seleccion, 6) + "");
        txtdoContraseña.setText(tblLista.getValueAt(seleccion, 7) + "");;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(i==JOptionPane.YES_OPTION){
            if (txtdoContraseña.getText().isEmpty() || txtCorreo.getText().isEmpty() || txtDireccion.getText().isEmpty() || txtCurso.getText().isEmpty() || txtSalario.getText().isEmpty() || txtNombre.getText().isEmpty() || txtTelefono.getText().isEmpty()){
                JOptionPane.showMessageDialog(null, "Llene todos los espacios");
            }else{
                Docentes doce = new Docentes();
                doce.setIdDocente(Integer.parseInt(txtCodigo.getText()));
                doce.setNombre(txtNombre.getText().trim());
                doce.setDireccion(txtDireccion.getText().trim());
                doce.setTelefono(Integer.parseInt(txtTelefono.getText()));
                doce.setEmail(txtCorreo.getText().trim());
                doce.setCurso(txtCurso.getText().trim());
                doce.setSalario(Integer.parseInt(txtSalario.getText()));
                doce.setDoContraseña(txtdoContraseña.getText().trim());
                String mensaje = doBo.agregarDocente(doce);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(i==JOptionPane.YES_OPTION){
            if (txtdoContraseña.getText().isEmpty() || txtCorreo.getText().isEmpty() || txtDireccion.getText().isEmpty() || txtCurso.getText().isEmpty() || txtSalario.getText().isEmpty() || txtNombre.getText().isEmpty() || txtTelefono.getText().isEmpty()){
                ...
                doce.setSalario(Integer.parseInt(txtSalario.getText()));
                doce.setDoContraseña(txtdoContraseña.getText().trim());
                String mensaje = doBo.modificarDocente(doce);
                JOptionPane.showMessageDialog(null, mensaje);
                limpiar();
                listarDocentes();
            }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(i==JOptionPane.YES_OPTION){
            if (txtdoContraseña.getText().isEmpty() || txtCorreo.getText().isEmpty() || txtDireccion.getText().isEmpty() || txtCurso.getText().isEmpty() || txtSalario.getText().isEmpty() || txtNombre.getText().isEmpty() || txtTelefono.getText().isEmpty()){
                ...
                String mensaje = doBo.eliminarDocente(Integer.parseInt(txtCodigo.getText()));
                JOptionPane.showMessageDialog(null, mensaje);
                limpiar();
                listarDocentes();
            }
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        // TODO add your handling code here:
        MenuAlumno menuDo = new MenuAlumno();
    ...
    private void txtMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMenuActionPerformed
        try {
            // TODO add your handling code here:
            MenuDocente menuDo = new MenuDocente();
            menuDo.setVisible(true);
            this.dispose();
    ...
    private void temCerrarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_temCerrarSesionActionPerformed
        // TODO add your handling code here:
        frmInicio inicio = new frmInicio();
        inicio.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_temCerrarSesionActionPerformed
    ...
    private javax.swing.JMenuItem temCerrarSesion;
    ...
    private javax.swing.JTextField txtdoContraseña;
